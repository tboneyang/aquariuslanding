...
var ready = function() {
  $(function() {
  	...
  	console.log("just a stepping stone, Thomas :)");
...
///
    ...
    MAX_PARTICLES = 100,
    DRAW_INTERVAL = 60,
    container = document.querySelector('.centered'),
...
function Circle() {
    this.settings = {ttl:9000, xmax:5, ymax:2, rmax:5, rt:1, xdef:960, ydef:540, xdrift:4, ydrift: 4, random:true, blink:true};
    ...
    this.draw = function() {
        ...
        gradient.addColorStop(0.0, 'rgba(1,1,1,'+newo+')');
        gradient.addColorStop(this.stop, 'rgba(7,10,8,'+(newo*.8)+')');
        gradient.addColorStop(1.0, 'rgba(7,10,8,0)');
